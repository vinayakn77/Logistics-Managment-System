            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="mainNav">
                    <div class="navbar-nav  " style="margin: 0 auto; font-size: large;">
                        ...
                        <a class="nav-item nav-link text-dark " href="login1.php">Customer Login</a>
            ...
            <div id = "carouselwithIndicators" class = "carousel slide container-fluid mt-10" data-ride = "carousel" style="width: 85%; height: 100%; border-radius: 15px;">
               ...
               <div class =" carousel-inner">
                  <div class = "carousel-item active">
                     <img class = "d-block " 
                        src = "Images/c5.jpg" 
                        alt = "First slide" style="height: 60vh; width: fit-content;">
                  </div>
                  
                  <div class = "carousel-item">
                     <img class = "d-block " 
                        src = "Images/c6.jpg" 
                        alt = "Second slide" style="height: 60vh; width: fit-content;">
                  </div>
                  <div class = "carousel-item">
                     <img class = "d-block " 
                        src = "Images/c3.jpg" 
                        alt = "Third slide" style="height: 60vh; width: fit-content;">
                  </div>
               </div>
         ...
         <div class="container" id="about" style="margin-top: 20px; width: 85%;">
             <div class="row">
                <div class="col-md-6 p-5" style="background-color: rgba(255, 255, 255, 0.7); color: black; border-radius: 15px; ">
                    ...
                    <p>The launch of<b> Logistics Express</b> from the house of Logistics Express Cargo services is exclusively designed to meet the commercial and personal shipment needs of our customers in both urban and rural destinations. We are emerging as a top destination for <b>‘same-day’</b> transportation and are continuously serving our customers 24/7/365. We constantly expand our resources to cater to our customer expectation addressing their unique market needs.</p>
                    <p class="pb-3" style="border-bottom: 2px solid white;">Having created a brand in the cargo industry we have ventured into the package delivery business with the same commitment. We offer flexible and faster delivery solutions. We have spread our footprints far and wide with our bouquet of products and services. We deliver promptly for all your time critical projects.</p>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-center p-5" style="background-color: rgba(255, 255, 255, 0.7); color: black;  "  id='contact'>
                        ...
                        <form action="index.php" class="form text-left" method = "POST">
                            ...
                            <div class="form-group">
                                <label>Email : </label>
                                <input class="form-contact"  type="email" name = "email" value=<?php echo $email; ?>>
