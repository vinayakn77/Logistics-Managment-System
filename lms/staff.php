    ...
    if(isset($_POST['submit'])){
        ...
        if(array_filter($errors)){
            ...
            if(mysqli_num_rows($result) > 0){
                ...
                echo "setTimeout(function () { swal('Service Not Available', 'Logistics Express will reach your place soon !!', 'info');";
                echo '}, 1000);</script>';
            }
        }
    }
    ...
    <body style="font-family: Tahoma, sans-serif">
            ...
            <div class="row">
                ...
                <div class="col-2 dropdown">
                    ...
                    <ul class="dropdown-menu text-center" id="dd-menu">
                        ...
                        <li><div><a href="logout.php" style="color: red; text-decoration: none;">Logout</a></div></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container mt-10">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  <a class="nav-link" id="update-tab" data-toggle="tab" href="#update" role="tab" aria-controls="update" aria-selected="false" style="color: black;">Order Details</a>
                </li>
                <li class="nav-item" role="presentation">
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" class="form" method="POST">
                            ...
                            <div class="col-md-6 p-3" style="background-color: rgba(255, 255, 255, 0.7);">
                                ...
                                <div class="form-group text-left pl-5">
                                    <label>Name    : </label>
                                    <input type="text" name="sname" style="border-radius: 8px;" required="true">
                                    <label class="text-danger"><?php echo $errors['req'];?></label>
                                </div>
                                <div class="form-group text-left pl-5">
                                    <label>Address : </label>
                                    <input type="text" name="sadd" style="border-radius: 8px;" required="true">
                                    <label class="text-danger"><?php echo $errors['req'];?></label>
                                </div>
                                <div class="form-group text-left pl-5">
                                    <label>City    : </label>
                                    <input type="text" name="scity" style="border-radius: 8px;" required="true"> 
                                    <label class="text-danger"><?php echo $errors['req'];?></label>
                                </div>
                                <div class="form-group text-left pl-5">
                                    <label>State : </label>
                                    <input type="text" name="sstate" style="border-radius: 8px;" required="true">
                                    <label class="text-danger"><?php echo $errors['req'];?></label>
                                </div>
                                <div class="form-group text-left pl-5">
                                    <label>Contact : </label>
                                    <input type="text" name="scontact" maxlength="10" pattern="\d{10}" title="Please enter exactly 10 digits"  style="border-radius: 8px;"/>

                                    <!-- <input type="text" name="scontact" title="Contact should be 10 digits" pattern="[0-9]{9}" style="border-radius: 8px;">   -->
                                    <!-- <input type="text" name="scontact" title="Contact should be 10 digits" pattern="[0-9]{9}" style="border-radius: 8px;"> -->
                                    <label class="text-danger"><?php echo $errors['req'];?></label>
                                </div>
                            </div>
                            <div class="col-md-6 p-3" style="background-color: rgba(255, 255, 255, 0.7);">
                                ...
                                <div class="form-group text-left pl-5">
                                    <label>Name : </label>
                                    <input type="text" name="rname" style="border-radius: 8px;" required="true">
                                    <label class="text-danger"><?php echo $errors['req'];?></label>
                                </div>
                                <div class="form-group text-left pl-5">
                                    <label>Address : </label>
                                    <input type="text" name="radd" style="border-radius: 8px;" required="true">
                                    <label class="text-danger"><?php echo $errors['req'];?></label>
                                </div>
                                <div class="form-group text-left pl-5">
                                    <label>City : </label>
                                    <input type="text" name="rcity" style="border-radius: 8px;" required="true">
                                    <label class="text-danger"><?php echo $errors['req'];?></label>
                                </div>
                                <div class="form-group text-left pl-5">
                                    <label>State : </label>
                                    <input type="text" name="rstate" style="border-radius: 8px;" required="true">
                                    <label class="text-danger"><?php echo $errors['req'];?></label>
                                </div>
                                <div class="form-group text-left pl-5">
                                    <label>Contact : </label>
                                    <input type="text" name="rcontact" maxlength="10" pattern="\d{10}" title="Please enter exactly 10 digits"  style="border-radius: 8px;"/>
                                    <!-- <input type="number" name="rcontact" title="Contact should be 10 digits" pattern="[0-9]{9}" required="true">   -->
                                    <!-- <input type="text" name="rcontact" style="border-radius: 8px;" required="true"> -->
                                    <label class="text-danger"><?php echo $errors['req'];?></label>
                                </div>
                                <div class="form-group text-left pl-5">
                                    <label>Weight : </label>
                                    <input type="text" name="wgt" style="border-radius: 8px;" required="true">
                                    <label class="text-danger"><?php echo $errors['req'];?></label>
                                </div>
                ...
                <div class="tab-pane fade" id="cons" role="tabpanel" aria-labelledby="cons-tab">
                    <ul class="nav nav-tabs" id="myTab2" role="tablist">
                      ...
                      <div class="tab-content b-0" id="myTabContent">
                        <div class="tab-pane fade show active" id="arr" role="tabpanel" aria-labelledby="arr-tab">
                            <table class="table table-hover table-bordered table-striped table-hover" style="background-color: rgba(255, 255, 255, 0.8);">
                                <thead class="thead-dark">
                                    <tr class="table-info"><td>TrackingID</td><td>StaffID</td><td>Sender</td><td>Receiver</td><td>Weight</td><td>Price</td><td>Dispatched</td><td>Shipped</td><td>Out for delivery</td></tr>                    
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <!-- <td><?php echo "<input type='submit' name='Delete' placeholder='Delete'>";?></td> -->
                        ...
                        <table class="table table-hover table-bordered table-striped table-hover" style="background-color: rgba(255, 255, 255, 0.8);" >
                                <thead class="thead-dark">
                                    <tr class="table-info"><td>Tracking ID</td><td>Staff ID</td><td>Sender</td><td>Receiver</td><td>Weight</td><td>Price</td><td>Dispatched</td><td>Shipped</td><td>Out for delivery</td><td>Delivered</td></tr>                    
                                </thead>
                                <tbody>
        ...
        <div class="container-fluid text-center mt-5" style="background-color: rgba(255, 255, 255, 0.7); padding: 20px; position: relative;">
            ...
            <p class="credit" style="font-size: 20px; font-stretch: 3px; text-align: center; color: black;">© Logistics Express</p>
        </div>
    </body>
</html>